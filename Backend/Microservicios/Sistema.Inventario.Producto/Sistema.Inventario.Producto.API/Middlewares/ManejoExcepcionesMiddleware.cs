...
/// <summary>
/// Middleware para mapear excepciones de validación a respuestas HTTP consistentes
/// </summary>
public class ManejoExcepcionesMiddleware
{
    ...
    /// <summary>
    /// Servicio de logging para registrar excepciones controladas
    /// </summary>
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        {
            _logger.LogWarning(ex, "Error de validación en request: {Mensaje}", ex.Message);
...
/// <summary>
/// Extensiones para registrar el middleware de manejo de excepciones en el pipeline
/// </summary>
